...
export const settings: Record<string, Translation> = {
  ...
  "settings.dokladFaktura": { cs: "📄 Faktura A4", sk: "📄 Faktúra A4" },
  "settings.dokladFakturaDesc": { cs: "Na běžnou tiskárnu nebo e-mailem", sk: "Na bežnú tlačiareň alebo e-mailom" },
  "settings.dokladHint": { cs: "Tisk dokladů bude v mobilní aplikaci. Volbu lze kdykoli změnit.", sk: "Tlač dokladov bude v mobilnej aplikácii. Voľbu možno kedykoľvek zmeniť." },
  ...
  "settings.notifMaster": { cs: "Zapnout upozornění", sk: "Zapnúť upozornenia" },
  "settings.notifMasterHint": {
    cs: "Hlavní vypínač všech upozornění. Jednotlivé druhy si nastavíš níže v Chytrých upozorněních.",
    sk: "Hlavný vypínač všetkých upozornení. Jednotlivé druhy si nastavíš nižšie v Chytrých upozorneniach.",
  },
