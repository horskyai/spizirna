  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "0 20px", minHeight: 0 }}>
        ...
        {/* ── ONBOARDING SLIDE ── */}
        {!isChoosing && (
          <div key={slide} className="animate-fade-in" style={{ flex: 1, minHeight: 0, overflowY: "auto", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "safe center", gap: 0, paddingBottom: 8 }}>
            <img
              src={current.img}
              alt=""
              width={104}
